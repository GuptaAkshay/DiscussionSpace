...
<ul class="topics">
        ...
        <li class="topic">
            <div class="row">
                <div class="col-md-2">
                    <img class="avatar pull-left" src="templates/images/avatars/<?php echo $topic->avatar; ?>" />
                </div>
                <div class="col-md-10">
                    <div class="topic-content pull-right">
                        ...
                        <div class="topic-info" >
                            ...
                            <span class="badge pull-right"><?php replyCount($topic->id); ?></span> 
                        </div>
                    </div>
                </div>	
            </div>
        ...
        <?php else:?>
            <p>Sorry! No Topics to Display.</p>
        <?php endif; ?>
    <ul>
